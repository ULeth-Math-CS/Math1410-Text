...
\mnote{.5}{\textbf{Note:} It's useful to state the number of parameters in the general solution to a system with infinitely many solutions, since the number of parameters has geometric significance. A one-parameter family of solutions defines a \textit{line}, while a two-parameter family of solutions defines a \textit{plane}.}
