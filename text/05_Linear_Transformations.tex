...
\definition{def:standard_unit}{Standard Unit Vectors}{\index{standard unit vector}
...
\example{ex_is_linear}{Using Key Idea \ref{idea:whenlinear} to identify linear transformations}{Using Key Idea \ref{idea:when_linear}, determine whether or not each of the following transformations is linear.\\
