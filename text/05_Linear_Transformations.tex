...
In the next section we introduce the concept of a \sword{subspace}. This subject is closely related to the concepts of span and linear independence covered in Section \ref{sec:Rn}. We introduce it here in preparation for our final section, where we will define two important subspaces associated to a matrix transformation: the null space and the column space.\\
