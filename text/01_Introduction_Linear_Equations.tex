...
\mnote{.7}{Chapter \ref{chapter:vectors} also presented us with a few situations where the ability to solve systems of equations would have come in handy, such as the derivation of the cross product formula, and when we wanted to compute the line of intersection of two planes.}
