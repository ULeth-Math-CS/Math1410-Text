...
\mnote{.7}{We will also soon see that the best way to visualize the set of \textit{complex numbers} is by identifying complex numbers with points in the Cartesian plane.}
\begin{center}

\myincludegraphics{figures/CartesianPlane-21}
