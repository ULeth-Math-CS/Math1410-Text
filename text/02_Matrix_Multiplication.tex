...
\example{ex_vector_multiplication}{Multiplying row and column vectors}{
Let \[
...
\example{ex_matrix_multiply_1}{A more general matrix product}{
...
\example{ex_matrix_multiply_2}{Multiplying matrices}{
Multiply 
\[
...
\example{ex_matrix_multiply_3}{An undefined product}{
...
\example{ex_matrix_multiply_4}{A vector product revisited}{
In Example \ref{ex_vector_multiplication}, we were told that the product \vx\vu\ was defined, where 
\[
