...
A system of linear equations is \textit{consistent} if it has a solution (perhaps more than one). A linear system is \textit{inconsistent} if it does not have a solution.}
...
\example{ex_ex_un_01}{Solving a linear system}{Find the solution to the linear system $$\begin{array}{ccccc} x_1 & +& x_2 & = & 1\\ 2x_1 & + & 2x_2 & = &2\end{array} . $$}
...
\example{ex_ex_un_3}{Verifying that a system is inconsistent}{Confirm that the linear system $$\begin{array}{ccccc} x&+&y&=&0 \\2x&+&2y&=&4 \end{array}$$ has no solution. }
...
\example{ex_ex_un_4}{Finding general and particular solutions}{Give the solution to a linear system whose augmented matrix in \rref\ is $$\bmx{ccccc} 1&-1&0&2&4\\ 0&0&1&-3&7\\ 0&0&0&0&0\\ \emx$$ and give two particular solutions.}
...
\example{ex_ex_un_5}{Finding general and particular solutions}{Find the solution to a linear system whose augmented matrix in \rref\ is $$\bmx{ccccc} 1&0&0&2&3\\0&1&0&4&5\\ \emx$$ and give two particular solutions.}
...
\example{ex_ex_un_6}{Finding general and particular solutions}{Find the solution to the linear system $$\begin{array}{ccccccc}x_1&+&x_2&+&x_3&=&5\\x_1&-&x_2&+&x_3&=&3\\ \end{array}$$ and give two particular solutions.}
...
\example{ex_variable_k}{Solving a system with a variable coefficient}{For what values of $k$ will the given system have exactly one solution, infinite solutions, or no solution?
